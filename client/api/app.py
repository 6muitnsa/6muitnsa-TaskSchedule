...
app.register_blueprint(reminder_routes.bp)
...
app.register_blueprint(remote_routes.bp)  # 注册远程访问路由
...
def start_scheduler():
    return jsonify(scheduler_service.start())

@app.route('/api/scheduler/stop', methods=['POST'])
def stop_scheduler():
    return jsonify(scheduler_service.stop())

@app.route('/api/scheduler/status', methods=['GET'])
def get_scheduler_status():
    return jsonify(scheduler_service.get_status())

@app.route('/api/scheduler/results', methods=['GET'])
def get_scheduler_results():
    return jsonify(scheduler_service.get_results())
